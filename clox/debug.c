...
static int dwordInstruction(const char* name, Chunk* chunk,
                            int offset) {
...
int disassembleInstruction(Chunk* chunk, int offset) {
  ...
  switch (instruction) {
    ...
    case OP_GET_LOCAL:
      return dwordInstruction("OP_GET_LOCAL", chunk, offset);
    case OP_SET_LOCAL:
      return dwordInstruction("OP_SET_LOCAL", chunk, offset);
    case OP_GET_GLOBAL:
